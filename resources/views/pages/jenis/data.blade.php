    ...
    <tbody>
        @foreach ($jenis as $c)
            <tr>
                ...
                <td class="d-flex">
                    {{-- Edit --}}
                    <button type="button" class="btn btn-success mx-2 " data-toggle="modal" data-target="#modal" data-mode="edit" data-id="{{ $c->id }}" data-nama="{{ $c->nama }}" data-kategory_id="{{ $c->kategory_id }}">
                    ...
                    <form action="jenis/{{ $c->id }}" method="POST" class="">
                        @csrf
                        @method('DELETE')

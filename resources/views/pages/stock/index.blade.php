...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Halaman ini untuk mengelola stok menu yang ada dalam restoran <span class="text-primary">Coffee Cashier</span></h6>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="mt-2 alert alert-danger alert-dismissible fade show" role="alert">
              ...
              <ul>
                @foreach ($errors->all() as $error)
                    <li>Data {{ $error }} stok belum di isi</li>
                @endforeach
              </ul>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
          ...
          {{-- Export --}}
          <a href="/stock/export/excel" class="btn btn-success mb-3 ti-export"> Export Excel</a>
          {{-- Import --}}

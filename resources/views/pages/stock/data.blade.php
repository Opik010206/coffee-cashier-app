<table class="table table-responsive-md table-hover" id="tbl-stock">
    <thead>
      <tr>
        <th scope="col">ID</th>
    ...
    <tbody>
        @foreach ($stock as $c)
            <tr>
                ...
                <td class="">
                    {{-- Edit --}}
                    <button type="button" class="btn btn-success mx-2 btn-icon" data-toggle="modal" data-target="#modal" data-mode="edit" data-id="{{ $c->id }}" data-menu_id="{{ $c->menu_id }}" data-jumlah="{{ $c->jumlah }}">

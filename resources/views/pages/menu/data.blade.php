<table class="table table-responsive-md table-hover" id="tbl-menu">
    <thead>
      <tr>
        <th scope="col">ID</th>
    ...
    <tbody>
        @foreach ($menu as $c)
            <tr>
                ...
                <td>
                    {{-- Edit --}}
                    <button type="button" class="btn btn-success mx-2 btn-icon" data-toggle="modal" data-target="#modal" data-mode="edit" data-id="{{ $c->id }}" data-nama="{{ $c->nama }}" data-harga="{{ $c->harga }}" data-image="{{ $c->image }}" data-deskripsi="{{ $c->deskripsi }}">

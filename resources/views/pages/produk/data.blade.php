    ...
    <tbody >
        @foreach ($produk as $c)
            <tr>
                ...
                <td>
                    {{-- Edit --}}
                    <button type="button" class="btn btn-success mx-2 btn-icon" data-toggle="modal" data-target="#modal" data-mode="edit" data-id="{{ $c->id }}" data-nama_produk="{{ $c->nama_produk }}" data-nama_supplier="{{ $c->nama_supplier }}" data-harga_beli="{{ $c->harga_beli }}" data-harga_jual="{{ $c->harga_jual }}" data-stock="{{ $c->stock }}" data-keterangan="{{ $c->keterangan }}">

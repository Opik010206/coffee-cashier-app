    ...
    <tbody>
        @foreach ($absensi as $c)
            <tr>
                ...
                <td class="">
                    {{-- Edit --}}
                    <button type="button" class="btn btn-success mx-2 btn-icon" data-toggle="modal" data-target="#modal" data-mode="edit" data-id="{{ $c->id }}" data-no_meja="{{ $c->no_meja }}" data-kapasitas="{{ $c->kapasitas }}" data-status="{{ $c->status }}">

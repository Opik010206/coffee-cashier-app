<table class="table table-responsive-md table-hover" id="tbl-pelanggan">
    <thead>
      <tr>
        <th scope="col">ID</th>
    ...
    <tbody>
        @foreach ($pelanggan as $c)
            <tr>
                ...
                <td class="">
                    {{-- Edit --}}
                    <button type="button" class="btn btn-success mx-2 btn-icon" data-toggle="modal" data-target="#modal" data-mode="edit" data-id="{{ $c->id }}" data-nama="{{ $c->nama }}" data-email="{{ $c->email }}" data-no_telp="{{ $c->no_telp }}" data-alamat="{{ $c->alamat }}">

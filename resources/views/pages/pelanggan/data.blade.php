    ...
    <tbody>
        @foreach ($pelanggan as $c)
            <tr>
                ...
                <td class="d-flex">
                    {{-- Edit --}}
                    <button type="button" class="btn btn-success mx-2 " data-toggle="modal" data-target="#modal" data-mode="edit" data-id="{{ $c->id }}" data-nama="{{ $c->nama }}" data-email="{{ $c->email }}" data-no_telp="{{ $c->no_telp }}" data-alamat="{{ $c->alamat }}">
                    ...
                    <form action="pelanggan/{{ $c->id }}" method="POST" class="">
                        @csrf
                        @method('DELETE')

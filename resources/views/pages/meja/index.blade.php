...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  ...
                  <h6 class="font-weight-normal mb-0">Halaman ini untuk mengelola data meja di restoran <span class="text-primary">Coffee Cashier</span></h6>
                </div>
              </div>
            </div>
          </div>
          ...
          {{-- Export --}}
          <a href="/meja/export/excel" class="btn btn-success mb-3 ti-export"> Export Excel</a>
          {{-- Import --}}
    ...
    <div class="modal fade" id="import" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form action="{{ route('import_meja') }}" method="POST" class="form" enctype="multipart/form-data">
              {{ csrf_field() }}

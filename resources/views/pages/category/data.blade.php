    ...
    <tbody>
        @foreach ($category as $c)
            <tr>
                ...
                <td class="d-flex">
                    {{-- Edit --}}
                    <button type="button" class="btn btn-success mx-2 " data-toggle="modal" data-target="#modal" data-mode="edit" data-id="{{ $c->id }}" data-nama="{{ $c->nama }}">
                    ...
                    <form action="category/{{ $c->id }}" method="POST" class="">
                        @csrf
                        @method('DELETE')
